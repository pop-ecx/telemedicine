      ...
      <div class="scroll-sidebar" data-simplebar>
        <div class="d-flex mb-4 align-items-center justify-content-between">
            <a href="index.html" class="text-nowrap logo-img ms-0 ms-md-1">
              <img src="assets/images/logos/user.png" width="180" alt="">
            </a>
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav" class="mb-4 pb-2">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-5"></i>
              <span class="hide-menu">Application Menu</span>
            </li>
        
        <li class="sidebar-item">
            <a class="sidebar-link warning-hover-bg" href="./details.php" aria-expanded="false">
                <span class="aside-icon p-2 bg-light-warning rounded-3">
                    <i class="ti ti-article fs-7 text-warning"></i>
                </span>
                <span class="hide-menu ms-2 ps-1">Patient Details</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a class="sidebar-link danger-hover-bg" href="./bookings.php" aria-expanded="false">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link success-hover-bg" href="./ui-card.html" aria-expanded="false">
                ...
                <span class="hide-menu ms-2 ps-1">Uploads</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a class="sidebar-link primary-hover-bg" href="./ui-forms.html" aria-expanded="false">
                ...
                <span class="hide-menu ms-2 ps-1">Receipts</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a class="sidebar-link indigo-hover-bg" href="./ui-typography.html" aria-expanded="false">
                ...
                <span class="hide-menu ms-2 ps-1">Doctor Reports</span>
            </a>
        </li>
        <li class="nav-small-cap">
            <i class="ti ti-dots nav-small-cap-icon fs-5"></i>
